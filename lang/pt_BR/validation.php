...
return [
    ...
    | pela classe de validação. Algumas regras têm múltiplas versões, como as
    | regras de tamanho. Sinta-se à vontade para ajustar cada mensagem.
    |
    */
    ...
    'present_with_all' => 'O campo :attribute deve estar presente quando todos os valores :values estiverem presentes.',
    ...
    'required_with_all' => 'O campo :attribute é obrigatório quando todos os valores :values estiverem presentes.',
