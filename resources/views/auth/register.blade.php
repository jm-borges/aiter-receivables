<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-common.text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')"
                required autofocus autocomplete="name" />
            <x-common.input-error :messages="$errors->get('name')" class="mt-2" />
        </div>
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-common.primary-button class="ms-4">
                {{ __('Register') }}
